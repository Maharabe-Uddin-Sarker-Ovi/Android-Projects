...
public class gridcard1 extends AppCompatActivity {

    private Button btninfo1, btninfo2, btninfo3,btninfo4,btninfo5;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gridcard1);
        ...
        btninfo1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(gridcard1.this, ExecutiveMembers1.class);
        ...
        btninfo2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(gridcard1.this, Notice.class);
                startActivity(intent);
            }
        });
        ...
        btninfo3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(gridcard1.this, Registration.class);
                startActivity(intent);
            }
        });
        ...
        btninfo4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(gridcard1.this, Achievements.class);
                startActivity(intent);
            }
        });
        ...
        btninfo5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(gridcard1.this, AboutUs.class);
                startActivity(intent);
            }
        });
    }
