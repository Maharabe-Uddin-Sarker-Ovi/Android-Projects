...
public class gridcard3 extends AppCompatActivity {

    private Button btninfo1, btninfo2, btninfo3,btninfo4,btninfo5;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gridcard3);
        ...
        btninfo1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(gridcard3.this, ExecutiveMembers3.class);
        ...
        btninfo2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(gridcard3.this, Notice.class);
                startActivity(intent);
            }
        });
        ...
        btninfo3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(gridcard3.this, Registration.class);
                startActivity(intent);
            }
        });
        ...
        btninfo4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(gridcard3.this, Achievements.class);
                startActivity(intent);
            }
        });
        ...
        btninfo5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(gridcard3.this, AboutUs.class);
                startActivity(intent);
            }
        });
    }
