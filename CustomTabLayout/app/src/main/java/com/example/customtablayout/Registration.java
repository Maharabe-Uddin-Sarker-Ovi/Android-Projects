    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SubmitSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else if (name.equals("Maharabe") ||name.equals("Ovi")){
                    invalid=true;
        ...
        categoryCountry.add("Bangladesh");
        ...
        sp.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long l) {
                if(parent.getItemAtPosition(position).equals("Select Country")){
                    ...
                    Colector+=item+"\n";
                    Toast.makeText(Registration.this, "Selected Country: "+item, Toast.LENGTH_SHORT).show();
                }
            }
